...
> [!IMPORTANT]
> This is a copy of the upstream (b44525f) pycscope (https://github.com/portante/pycscope),
> which is not expected to be updated any more.
> PyCScope depends on the 'parse' standard python module which was deprecated circa 3.10.
> While it can parse newer python code just about correctly,
> it will become increasingly hard to run.
> It should also be noted that it **is** compatible with Csope 16.0,
> and presumably upwards as the reffile format is no longer expected to change.
